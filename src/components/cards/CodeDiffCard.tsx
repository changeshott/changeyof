...
export function CodeDiffCard({ onClick }: { onClick?: () => void }) {
  ...
  return (
    ...
    >
      <div className="absolute -inset-2 bg-gradient-to-r from-red-500 via-yellow-500 to-green-500 rounded-[24px] blur-xl opacity-0 group-hover:opacity-20 transition-opacity duration-500 -z-10"></div>
      ...
      <div className="flex items-center justify-between px-4 py-2.5 bg-white/[0.02] border-b border-white/5 rounded-t-2xl relative overflow-hidden">
        ...
        <div className="flex gap-1.5 relative z-10">
          <div className="w-3 h-3 rounded-full bg-red-500/80 shadow-[0_0_5px_rgba(239,68,68,0.5)] group-hover:shadow-[0_0_10px_rgba(239,68,68,0.8)] transition-shadow" />
          <div className="w-3 h-3 rounded-full bg-yellow-500/80 shadow-[0_0_5px_rgba(234,179,8,0.5)] group-hover:shadow-[0_0_10px_rgba(234,179,8,0.8)] transition-shadow" />
